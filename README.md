...
- **Insight Engine**: A rule-based correlation engine that identifies patterns (e.g., "Low sleep triggers headaches").
...
1. Clone the repository:
   ```bash
   git clone https://github.com/SamuelIkanio/syntra-pro.git
   ```
...
## 🛡️ Security
This project uses JWT for secure authentication. Ensure you set a `JWT_SECRET` environment variable in production.

---
Built with ❤️ by **SYNTRA** (for Triune Dynamic Limited).
