        ...
        <div className="max-w-lg mx-auto px-4 py-3 flex items-center justify-between">
          ...
          <div className="flex items-center gap-2">
            ...
            <motion.button
              ...
              className="relative w-9 h-9 rounded-xl glass-card flex items-center justify-center text-text-muted hover:text-accent-indigo transition-colors"
              data-testid="bell-button"
            >
              <Bell className="w-[18px] h-[18px]" />
              {hasUnread && (
                <span
                  className="absolute -top-0.5 -right-0.5 w-2.5 h-2.5 rounded-full bg-accent-rose border-2 border-bg-primary"
